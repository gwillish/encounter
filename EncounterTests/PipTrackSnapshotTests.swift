...
//
  ...
  struct PipTrackSnapshotTests {
    ...
    @Test func hp_full() {
      assertSnapshot(
        of: PipTrack(current: 6, maximum: 6, filledSymbol: "heart.fill", emptySymbol: "heart")
          .padding(),
    ...
    @Test func hp_half() {
      assertSnapshot(
        of: PipTrack(current: 3, maximum: 6, filledSymbol: "heart.fill", emptySymbol: "heart")
          .padding(),
        as: .image(layout: SnapshotLayout.badge)
      )
    }
    ...
    @Test func hp_critical() {
      assertSnapshot(
        of: PipTrack(current: 1, maximum: 6, filledSymbol: "heart.fill", emptySymbol: "heart")
          .padding(),
        as: .image(layout: SnapshotLayout.badge)
      )
    }
    ...
    @Test func textFallback() {
      assertSnapshot(
        of: PipTrack(current: 8, maximum: 14, filledSymbol: "heart.fill", emptySymbol: "heart")
          .padding(),
        as: .image(layout: SnapshotLayout.badge)
      )
    }
